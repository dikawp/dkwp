...
export const Main = () => {
  ...
  return (
    <div className="h-screen pt-48 lg:pt-40">
      <p className="hello text-center text-xl font-semibold">Yahallo, I'm</p>
      <h1 className="main text-center text-xl lg:text-3xl font-bold my-3">
        Ramadika Wijaya Poetra S.
      </h1>
      <h1 className="main text-center text-lg font-semibold text-gray-400 my-5 ">
      ...
      <ul className="main flex justify-center text-4xl gap-12 text-gray-500 dark:text-gray-400 mb-12">
        ...
        <li className="hover:text-red-600 dark:hover:text-white transition duration-500 ease-in-out">
          <a href="https://github.com/dikawp">
            <svg
              stroke="currentColor"
              fill="currentColor"
              strokeWidth="0"
        ...
        <li className="hover:text-red-600 dark:hover:text-white transition duration-500 ease-in-out">
          <a href="https://www.instagram.com/dikawp_16/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="1em"
              width="1em"
      ...
      <div className="main text-center my-10">
        ...
        <a
          className="m-3 py-3 px-6 border-2 bg-red-800 text-lg lg:m-5 font-semibold rounded-md text-white"
      ...
      <div className="main flex justify-center">
        <img
          src={avatar}
          alt="Profile"
          className="rounded-full h-48 w-48 my-4 text-center"
        />
      </div>
    </div>
  );
